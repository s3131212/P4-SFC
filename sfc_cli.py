...
def main():
    ...
    parser.add_argument("-f", '--p4info', 
                        help="install pipeline line using cli (p4info)",
                        type=bool, action="store", required=False)
    parser.add_argument("-n", '--p4info_name',
                        help="the name of pipeline",
                        type=str, action="store", required=False)
    parser.add_argument("-r", '--runtime',
                        help="set runtime or not",
                        type=bool, action="store", required=False)
    ...
    if args.p4info:
        if not name:
            print("You need to provide the name of p4info file!")
            return 
